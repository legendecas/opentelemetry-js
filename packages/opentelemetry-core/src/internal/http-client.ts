...
export interface RequestInit {
  ...
  method?: string;
  /**
   * Content type of the payload. It is appended to request headers if the http client supports it.
   * Example: 'application/json'
   */
  contentType?: string;
  /**
   * User agent of the request. It is appended to request headers if the http client supports it.
   */
  userAgent?: string;
  /**
   * Request headers.
  ...
  timeoutMs?: number;
  /**
   * Suggestive option, this may not be supported by every http client.
   */
