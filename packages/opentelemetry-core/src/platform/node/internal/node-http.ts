...
import { CreateHttpRequestOptions } from '../../../internal/http-clients/http';

export const isHttpRequestAvailable = () => true;
export function createHttpRequest(options: CreateHttpRequestOptions) {
  let agent;
  ...
  const httpRequest: RequestFunction = (url, payload, requestInit) => {
    ...
    const options: http.RequestOptions | https.RequestOptions = {
      ...
      headers: {
        ...
        'user-agent': requestInit?.userAgent ?? `OpenTelemetry/${VERSION}`,
        ...requestInit?.headers,
      },
      // TODO:
    ...
    // TODO:
    switch (requestInit?.compression) {
